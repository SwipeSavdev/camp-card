...
VALUES
-- Restaurants
(1, gen_random_uuid(), 1, 'Pizza Palace', 'Pizza Palace LLC', 'Family-owned pizzeria serving authentic Italian pizza since 1985. Fresh ingredients, homemade dough daily.', 'RESTAURANTS', '12-3456789', 'John Smith', 'info@pizzapalace.com', '555-0101', 'https://pizzapalace.com', 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=200', 'APPROVED', true, 2, 2, 0, NOW(), NOW()),
(2, gen_random_uuid(), 1, 'Burger Barn', 'Burger Barn Inc', 'Gourmet burgers made from locally sourced, grass-fed beef. Over 20 specialty burger options.', 'RESTAURANTS', '23-4567890', 'Jane Doe', 'hello@burgerbarn.com', '555-0102', 'https://burgerbarn.com', 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=200', 'APPROVED', true, 2, 2, 0, NOW(), NOW()),
(3, gen_random_uuid(), 1, 'Taco Town', 'Taco Town Express', 'Authentic Mexican cuisine with a modern twist. Fresh tacos, burritos, and quesadillas made to order.', 'RESTAURANTS', '34-5678901', 'Miguel Garcia', 'contact@tacotown.com', '555-0103', 'https://tacotown.com', 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200', 'APPROVED', true, 1, 1, 0, NOW(), NOW()),
-- Retail
(4, gen_random_uuid(), 1, 'Sports Galaxy', 'Sports Galaxy Stores', 'Your one-stop shop for all sporting goods. Equipment, apparel, and accessories for every sport.', 'RETAIL', '45-6789012', 'Tom Wilson', 'sales@sportsgalaxy.com', '555-0201', 'https://sportsgalaxy.com', 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=200', 'APPROVED', true, 2, 2, 0, NOW(), NOW()),
(5, gen_random_uuid(), 1, 'Book Haven', 'Book Haven LLC', 'Independent bookstore with over 50,000 titles. New releases, classics, and rare finds.', 'RETAIL', '56-7890123', 'Sarah Johnson', 'books@bookhaven.com', '555-0202', 'https://bookhaven.com', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200', 'APPROVED', true, 1, 1, 0, NOW(), NOW()),
-- Entertainment
(6, gen_random_uuid(), 1, 'Fun Zone Arcade', 'Fun Zone Entertainment', 'Family entertainment center with arcade games, mini-golf, go-karts, and laser tag.', 'ENTERTAINMENT', '67-8901234', 'Chris Martin', 'play@funzone.com', '555-0301', 'https://funzone.com', 'https://images.unsplash.com/photo-1511882150382-421056c89033?w=200', 'APPROVED', true, 2, 2, 0, NOW(), NOW()),
(7, gen_random_uuid(), 1, 'Cinema Plus', 'Cinema Plus Theaters', 'Premium movie experience with IMAX, 4DX, and luxury recliners. Fresh popcorn and gourmet concessions.', 'ENTERTAINMENT', '78-9012345', 'Amanda Lee', 'movies@cinemaplus.com', '555-0302', 'https://cinemaplus.com', 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=200', 'APPROVED', true, 1, 1, 0, NOW(), NOW()),
-- Services
...
-- MERCHANT LOCATIONS
-- ============================================================================
INSERT INTO merchant_locations (merchant_id, location_name, street_address, city, state, zip_code, latitude, longitude, phone, primary_location)
VALUES
...
-- OFFERS
-- ============================================================================
INSERT INTO offers (id, uuid, merchant_id, title, description, discount_type, discount_value, min_purchase_amount, max_discount_amount, category, terms, image_url, status, valid_from, valid_until, usage_limit, usage_limit_per_user, total_redemptions, featured, scout_exclusive, requires_qr_verification, created_at, updated_at)
VALUES
-- Pizza Palace Offers
(1, gen_random_uuid(), 1, '20% Off Any Large Pizza', 'Get 20% off any large pizza with your Camp Card. Perfect for family dinners!', 'PERCENTAGE', 20.00, 15.00, 10.00, 'RESTAURANTS', 'Valid on dine-in and carryout. Cannot be combined with other offers.', 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '90 days', 1000, 3, 0, true, false, true, NOW(), NOW()),
(2, gen_random_uuid(), 1, 'Free Garlic Bread with Order', 'Enjoy complimentary garlic bread with any pizza purchase of $20 or more.', 'FREE_ITEM', 0, 20.00, NULL, 'RESTAURANTS', 'One free garlic bread per order. Minimum $20 purchase required.', 'https://images.unsplash.com/photo-1619531040576-f9416aabed4e?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '60 days', 500, 5, 0, false, true, true, NOW(), NOW()),
-- Burger Barn Offers
(3, gen_random_uuid(), 2, 'Buy One Get One Free Burgers', 'Buy any signature burger and get a second one free. Scout exclusive deal!', 'BUY_ONE_GET_ONE', 0, 12.00, 15.00, 'RESTAURANTS', 'Second burger must be of equal or lesser value.', 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '45 days', 200, 2, 0, true, true, true, NOW(), NOW()),
(4, gen_random_uuid(), 2, '$5 Off Family Meal', 'Save $5 on any family meal combo for 4 people or more.', 'FIXED_AMOUNT', 5.00, 30.00, 5.00, 'RESTAURANTS', 'Valid on family meals for 4+ people.', 'https://images.unsplash.com/photo-1550547660-d9450f859349?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '30 days', 300, 3, 0, false, false, true, NOW(), NOW()),
-- Taco Town Offers
(5, gen_random_uuid(), 3, '15% Off Entire Order', 'Save 15% on your entire order at Taco Town. Valid any day!', 'PERCENTAGE', 15.00, 10.00, 8.00, 'RESTAURANTS', 'Cannot be combined with daily specials.', 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '60 days', 800, 5, 0, false, false, true, NOW(), NOW()),
-- Sports Galaxy Offers
(6, gen_random_uuid(), 4, '25% Off Camping Gear', 'Get 25% off all camping equipment. Perfect for Scout camping trips!', 'PERCENTAGE', 25.00, 50.00, 75.00, 'RETAIL', 'Valid on camping tents, sleeping bags, backpacks.', 'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '90 days', 500, 2, 0, true, true, true, NOW(), NOW()),
(7, gen_random_uuid(), 4, '$10 Off $50+ Purchase', 'Save $10 when you spend $50 or more on sporting goods.', 'FIXED_AMOUNT', 10.00, 50.00, 10.00, 'RETAIL', 'Minimum $50 purchase required.', 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '60 days', 400, 3, 0, false, false, true, NOW(), NOW()),
-- Book Haven Offers
(8, gen_random_uuid(), 5, '20% Off Any Purchase', 'Get 20% off any book purchase. Feed your mind for less!', 'PERCENTAGE', 20.00, NULL, 20.00, 'RETAIL', 'Valid on all books including new releases.', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '120 days', 1000, 10, 0, false, false, true, NOW(), NOW()),
-- Fun Zone Arcade Offers
(9, gen_random_uuid(), 6, 'Free Game Card with Admission', 'Get a free $10 game card when you pay for admission!', 'FREE_ITEM', 10.00, 15.00, NULL, 'ENTERTAINMENT', 'One free game card per paid admission.', 'https://images.unsplash.com/photo-1511882150382-421056c89033?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '90 days', 600, 3, 0, true, false, true, NOW(), NOW()),
(10, gen_random_uuid(), 6, '50% Off Go-Kart Rides', 'Half price go-kart rides for Scouts!', 'PERCENTAGE', 50.00, NULL, 15.00, 'ENTERTAINMENT', 'Valid for single or double go-kart rides.', 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '60 days', 400, 2, 0, false, true, true, NOW(), NOW()),
-- Cinema Plus Offers
(11, gen_random_uuid(), 7, '$3 Off Movie Tickets', 'Save $3 on any movie ticket!', 'FIXED_AMOUNT', 3.00, NULL, 3.00, 'ENTERTAINMENT', 'Valid on standard, 3D, and IMAX tickets.', 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '90 days', 1500, 5, 0, false, false, true, NOW(), NOW()),
-- Quick Oil Change Offers
(12, gen_random_uuid(), 8, '$15 Off Synthetic Oil Change', 'Premium synthetic oil change at a discount!', 'FIXED_AMOUNT', 15.00, NULL, 15.00, 'AUTOMOTIVE', 'Valid on full synthetic oil changes only.', 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '180 days', 300, 2, 0, false, false, true, NOW(), NOW()),
-- Outdoor Adventures Offers
(13, gen_random_uuid(), 9, '30% Off Scout Uniforms', 'Official Scout uniforms and patches at 30% off!', 'PERCENTAGE', 30.00, 25.00, 50.00, 'RETAIL', 'Valid on all official BSA uniforms and patches.', 'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '120 days', 800, 3, 0, true, true, true, NOW(), NOW()),
(14, gen_random_uuid(), 9, 'Free Water Bottle with $40 Purchase', 'Get a free reusable water bottle when you spend $40+', 'FREE_ITEM', 0, 40.00, NULL, 'RETAIL', 'Free 32oz water bottle with $40+ purchase.', 'https://images.unsplash.com/photo-1502666229322-48fc27e9e020?w=800', 'ACTIVE', NOW() - INTERVAL '1 day', NOW() + INTERVAL '60 days', 200, 1, 0, false, false, true, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
