...
**Target Market:**
- **Primary sellers:** Scouts ages 5–14 (with troop leader supervision)
 ...
 └─ Local Council (e.g., Central Florida Council, Bay Area Council)
     └─ District (optional organizational layer)
         └─ Troop / Pack / Unit
             ...
             └─ Scouts (youth members, ages 5–18)
```
...
- **Age:** Typically 5–18 years old (minors)
...
- Multi-council deployment (3–5 councils)
