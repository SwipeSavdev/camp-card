...
export default function LeaderSettings() {
 ...
 const [settings, setSettings] = useState<LeaderSettings>({
 ...
 const updateSetting = async (key: keyof LeaderSettings, value: boolean) => {
 if (!user?.id) return;
 ...
 Alert.alert("Export Report", "Generating your troop report...");
 };

 const handleViewAnalytics = () => {
 Alert.alert("View Analytics", "Opening analytics dashboard...");
 };
 ...
 Scout activity and earnings updates
 </Text>
 </View>
 </View>
 <Switch
 ...
 >
 <View style={{ flexDirection: "row", alignItems: "center", gap: space.md }}>
 <Ionicons name="download-outline" size={20} color={colors.blue500} />
 <Text style={{ fontSize: 14, fontWeight: "600", color: colors.text }}>
 Export Report
 </Text>
 </View>
 ...
 >
 <View style={{ flexDirection: "row", alignItems: "center", gap: space.md }}>
 <Ionicons name="bar-chart-outline" size={20} color={colors.green500} />
 <Text style={{ fontSize: 14, fontWeight: "600", color: colors.text }}>
 View Analytics
 </Text>
 </View>
