...
const Icon = ({ name, size = 18, color = 'currentColor', ...props }: { name: string; size?: number; color?: string; [key: string]: any }) => {
 ...
 toggle: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><rect x="1" y="5" width="22" height="14" rx="7" ry="7" /><circle cx="16" cy="12" r="5" /></svg>,
 };
...
export default function SettingsPage() {
 ...
 <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: themeSpace.xl, maxWidth: '1200px' }}>
 {/* Sidebar */}
 <div>
 ...
 {/* General Settings */}
 {activeTab === 'general' && (
 <div style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, border: `1px solid ${themeColors.gray200}`, padding: themeSpace.xl }}>
 <h2 style={{ fontSize: '20px', fontWeight: '700', color: themeColors.text, margin: '0 0 24px 0' }}>General Settings</h2>

 <div style={{ marginBottom: themeSpace.lg }}>
 <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', marginBottom: themeSpace.sm }}>Application Name</label>
 <input
 type="text"
 ...
 <div style={{ marginBottom: themeSpace.lg }}>
 <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', marginBottom: themeSpace.sm }}>API Base URL</label>
 <input
 type="text"
 ...
 <div style={{ marginBottom: themeSpace.lg }}>
 <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', marginBottom: themeSpace.sm }}>Request Timeout (ms)</label>
 <input
 type="number"
 ...
 <div style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, border: `1px solid ${themeColors.gray200}`, padding: themeSpace.xl }}>
 <h2 style={{ fontSize: '20px', fontWeight: '700', color: themeColors.text, margin: '0 0 24px 0' }}>Notification Preferences</h2>
 ...
 <div key={item.key} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: themeSpace.lg, borderBottom: `1px solid ${themeColors.gray100}` }}>
 <div>
 <p style={{ margin: 0, fontSize: '14px', fontWeight: '600', color: themeColors.text }}>{item.label}</p>
 ...
 {activeTab === 'security' && (
 <div style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, border: `1px solid ${themeColors.gray200}`, padding: themeSpace.xl }}>
 <h2 style={{ fontSize: '20px', fontWeight: '700', color: themeColors.text, margin: '0 0 24px 0' }}>Security Settings</h2>
 ...
 <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', marginBottom: themeSpace.sm }}>Session Timeout (seconds)</label>
 <input
 type="number"
 ...
 {activeTab === 'api' && (
 <div style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, border: `1px solid ${themeColors.gray200}`, padding: themeSpace.xl }}>
 <h2 style={{ fontSize: '20px', fontWeight: '700', color: themeColors.text, margin: '0 0 24px 0' }}>API Keys</h2>
 ...
 <div style={{ marginTop: themeSpace.xl, padding: themeSpace.xl, backgroundColor: themeColors.gray50, borderRadius: themeRadius.card, textAlign: 'center', color: themeColors.gray600 }}>
