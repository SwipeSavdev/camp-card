...
const themeRadius = { sm: '4px', md: '8px', card: '12px', lg: '16px' };
const themeShadow = { xs: '0 1px 2px 0 rgba(0, 0, 0, 0.05)', sm: '0 1px 3px 0 rgba(0, 0, 0, 0.1)', md: '0 4px 6px -1px rgba(0, 0, 0, 0.1)', lg: '0 10px 15px -3px rgba(0, 0, 0, 0.1)' };
...
const Icon = ({ name, size = 18, color = 'currentColor' }: { name: string; size?: number; color?: string }) => {
  const icons: Record<string, JSX.Element> = {
    ...
    megaphone: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><path d="M3 11l18-5v12L3 13v-2z" /><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6" /></svg>,
    ...
    email: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg>,
    ...
    inbox: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12" /><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /></svg>,
    ...
    award: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><circle cx="12" cy="8" r="7" /><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88" /></svg>,
    brain: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><path d="M12 2a4 4 0 0 1 4 4c0 1.1-.9 2-2 2h-4c-1.1 0-2-.9-2-2a4 4 0 0 1 4-4z" /><path d="M8 8v2a6 6 0 0 0 8 0V8" /><path d="M6 12h12" /><path d="M6 16h12" /><path d="M10 20h4" /></svg>,
    ...
    trendingUp: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18" /><polyline points="17 6 23 6 23 12" /></svg>,
    trendingDown: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><polyline points="23 18 13.5 8.5 8.5 13.5 1 6" /><polyline points="17 18 23 18 23 12" /></svg>,
    ...
    globe: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><circle cx="12" cy="12" r="10" /><line x1="2" y1="12" x2="22" y2="12" /><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" /></svg>,
  };
...
export default function AIMarketingPage() {
  ...
  const getCampaignTypeInfo = (typeId: string) => {
    return CAMPAIGN_TYPES.find(t => t.id === typeId) || CAMPAIGN_TYPES[0];
  };
    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: themeColors.gray50 }}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: themeSpace.xl, backgroundColor: themeColors.white, borderBottom: `1px solid ${themeColors.gray200}`, boxShadow: themeShadow.xs }}>
          ...
          {/* Tabs */}
          <div style={{ display: 'flex', gap: themeSpace.xs, backgroundColor: themeColors.gray100, padding: themeSpace.xs, borderRadius: themeRadius.md }}>
            {[
        ...
        <div style={{ flex: 1, padding: themeSpace.xl, overflowY: 'auto' }}>
            ...
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: themeSpace.lg, marginBottom: themeSpace.xl }}>
                {[
                  ...
                  <div key={idx} style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, padding: themeSpace.lg, border: `1px solid ${themeColors.gray200}`, boxShadow: themeShadow.sm }}>
              ...
              <div style={{ display: 'flex', gap: themeSpace.md, marginBottom: themeSpace.lg, flexWrap: 'wrap' }}>
                ...
                <select
                  ...
                  style={{ padding: `${themeSpace.sm} ${themeSpace.md}`, border: `1px solid ${themeColors.gray200}`, borderRadius: themeRadius.sm, fontSize: '14px', backgroundColor: themeColors.white, cursor: 'pointer', minWidth: '140px' }}
                >
                ...
                <select
                  ...
                  style={{ padding: `${themeSpace.sm} ${themeSpace.md}`, border: `1px solid ${themeColors.gray200}`, borderRadius: themeRadius.sm, fontSize: '14px', backgroundColor: themeColors.white, cursor: 'pointer', minWidth: '160px' }}
                >
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr style={{ backgroundColor: themeColors.gray50 }}>
                      <th style={{ padding: themeSpace.md, textAlign: 'left', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Campaign</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'left', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Type</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'center', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Status</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'center', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Channels</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Sent</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Opened</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Converted</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>ROI</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'center', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      return (
                        <tr key={campaign.id} style={{ borderBottom: `1px solid ${themeColors.gray100}` }}>
                          ...
                          <td style={{ padding: themeSpace.md, textAlign: 'center' }}>
                            <span style={{ padding: `${themeSpace.xs} ${themeSpace.sm}`, backgroundColor: statusColor.bg, color: statusColor.text, borderRadius: themeRadius.sm, fontSize: '12px', fontWeight: '500', textTransform: 'capitalize' }}>
                              {campaign.status}
                            </span>
                          </td>
                          <td style={{ padding: themeSpace.md, textAlign: 'center' }}>
                          ...
                          <td style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '14px', color: themeColors.text }}>{campaign.sent.toLocaleString()}</td>
                          <td style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '14px', color: themeColors.text }}>{campaign.opened.toLocaleString()}</td>
                          <td style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '14px', color: themeColors.text }}>{campaign.converted.toLocaleString()}</td>
                          <td style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '14px', fontWeight: '600', color: campaign.roi.startsWith('+') ? themeColors.success600 : themeColors.gray500 }}>{campaign.roi}</td>
                          <td style={{ padding: themeSpace.md, textAlign: 'center' }}>
                            <div style={{ display: 'flex', justifyContent: 'center', gap: themeSpace.xs }}>
                              <button style={{ background: 'none', border: 'none', cursor: 'pointer', padding: themeSpace.xs }} title="Edit">
              ...
              {/* Pagination */}
              {totalPages > 1 && (
                <div style={{ display: 'flex', justifyContent: 'center', gap: themeSpace.sm, marginTop: themeSpace.lg }}>
                  <button
                    onClick={() => setCurrentPage(p => Math.max(1, p - 1))}
                    disabled={currentPage === 1}
                    style={{ padding: `${themeSpace.sm} ${themeSpace.md}`, border: `1px solid ${themeColors.gray200}`, borderRadius: themeRadius.sm, backgroundColor: themeColors.white, cursor: currentPage === 1 ? 'not-allowed' : 'pointer', opacity: currentPage === 1 ? 0.5 : 1 }}
                  >
                  ...
                  <button
                    ...
                    style={{ padding: `${themeSpace.sm} ${themeSpace.md}`, border: `1px solid ${themeColors.gray200}`, borderRadius: themeRadius.sm, backgroundColor: themeColors.white, cursor: currentPage === totalPages ? 'not-allowed' : 'pointer', opacity: currentPage === totalPages ? 0.5 : 1 }}
                  >
          ...
          {activeTab === 'segments' && (
            <div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: themeSpace.lg }}>
                {segments.map((segment) => (
                  <div key={segment.id} style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, padding: themeSpace.lg, border: `1px solid ${themeColors.gray200}`, boxShadow: themeShadow.sm }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: themeSpace.md }}>
                      <div>
                        <h3 style={{ fontSize: '16px', fontWeight: '600', color: themeColors.text, margin: 0, marginBottom: themeSpace.xs }}>{segment.name}</h3>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <button style={{ background: themeColors.primary50, border: 'none', color: themeColors.primary600, padding: `${themeSpace.sm} ${themeSpace.md}`, borderRadius: themeRadius.sm, cursor: 'pointer', fontSize: '13px', fontWeight: '500' }}>
                        Create Campaign
                      </button>
                    </div>
                  </div>
              ...
              {/* Segment Performance */}
              <div style={{ marginTop: themeSpace.xl, backgroundColor: themeColors.white, borderRadius: themeRadius.card, padding: themeSpace.lg, border: `1px solid ${themeColors.gray200}` }}>
                <h3 style={{ fontSize: '16px', fontWeight: '600', color: themeColors.text, margin: 0, marginBottom: themeSpace.lg }}>Segment Performance</h3>
          ...
          {activeTab === 'analytics' && (
            <div>
              {/* KPI Cards */}
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: themeSpace.lg, marginBottom: themeSpace.xl }}>
                {[
                  ...
                  <div key={idx} style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, padding: themeSpace.lg, border: `1px solid ${themeColors.gray200}` }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: themeSpace.sm }}>
                    ...
                    <div style={{ fontSize: '12px', color: themeColors.success600, marginTop: themeSpace.xs }}>
                      <Icon name="trendingUp" size={12} color={themeColors.success600} /> {kpi.change}
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: themeSpace.lg }}>
                ...
                <div style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, padding: themeSpace.lg, border: `1px solid ${themeColors.gray200}` }}>
                  <h3 style={{ fontSize: '16px', fontWeight: '600', color: themeColors.text, margin: 0, marginBottom: themeSpace.lg }}>Campaign Performance</h3>
                ...
                {/* Conversions by Type */}
                <div style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, padding: themeSpace.lg, border: `1px solid ${themeColors.gray200}` }}>
                  <h3 style={{ fontSize: '16px', fontWeight: '600', color: themeColors.text, margin: 0, marginBottom: themeSpace.lg }}>Conversions by Campaign Type</h3>
                  <ResponsiveContainer width="100%" height={250}>
                    <PieChart>
                      <Pie
                ...
                {/* Channel Performance */}
                <div style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, padding: themeSpace.lg, border: `1px solid ${themeColors.gray200}`, gridColumn: 'span 2' }}>
                  <h3 style={{ fontSize: '16px', fontWeight: '600', color: themeColors.text, margin: 0, marginBottom: themeSpace.lg }}>Channel Performance</h3>
                  <div style={{ overflowX: 'auto' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                      <thead>
                        <tr>
                          <th style={{ padding: themeSpace.md, textAlign: 'left', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Channel</th>
                          <th style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Sent</th>
                          <th style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Opened</th>
                          <th style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Converted</th>
                          <th style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '13px', fontWeight: '600', color: themeColors.gray600, borderBottom: `1px solid ${themeColors.gray200}` }}>Conversion Rate</th>
                        </tr>
                      </thead>
                      <tbody>
                        {mockAnalyticsData.channelPerformance.map((channel, idx) => (
                          <tr key={idx}>
                            ...
                            <td style={{ padding: themeSpace.md, textAlign: 'right', fontWeight: '600', color: themeColors.success600 }}>{channel.rate}%</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
          ...
          {activeTab === 'merchants' && (
            <div>
              ...
              {/* Merchants List */}
              <div style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, border: `1px solid ${themeColors.gray200}`, overflow: 'hidden' }}>
                <div style={{ padding: themeSpace.lg, borderBottom: `1px solid ${themeColors.gray200}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <h3 style={{ fontSize: '16px', fontWeight: '600', color: themeColors.text, margin: 0 }}>Merchant Network</h3>
                  <button style={{ background: themeColors.primary50, border: 'none', color: themeColors.primary600, padding: `${themeSpace.sm} ${themeSpace.md}`, borderRadius: themeRadius.sm, cursor: 'pointer', fontSize: '13px', fontWeight: '500', display: 'flex', alignItems: 'center', gap: themeSpace.xs }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr style={{ backgroundColor: themeColors.gray50 }}>
                      <th style={{ padding: themeSpace.md, textAlign: 'left', fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Merchant</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'left', fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Category</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'left', fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Location</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'center', fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Campaigns</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'right', fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Redemptions</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'center', fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Rating</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'center', fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Status</th>
                      <th style={{ padding: themeSpace.md, textAlign: 'center', fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {mockMerchants.map((merchant) => (
                      <tr key={merchant.id} style={{ borderBottom: `1px solid ${themeColors.gray100}` }}>
                        ...
                        <td style={{ padding: themeSpace.md }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: themeSpace.xs, color: themeColors.gray600, fontSize: '14px' }}>
                        ...
                        <td style={{ padding: themeSpace.md, textAlign: 'center' }}>
                          <span style={{ display: 'inline-flex', alignItems: 'center', gap: themeSpace.xs, color: themeColors.warning600 }}>
                        ...
                        <td style={{ padding: themeSpace.md, textAlign: 'center' }}>
                          <div style={{ display: 'flex', justifyContent: 'center', gap: themeSpace.xs }}>
                            <button style={{ background: 'none', border: 'none', cursor: 'pointer', padding: themeSpace.xs }} title="View Details">
                              <Icon name="eye" size={16} color={themeColors.gray500} />
                            </button>
                            <button style={{ background: 'none', border: 'none', cursor: 'pointer', padding: themeSpace.xs }} title="Create Campaign">
        ...
        {showCreateForm && (
          <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 50, padding: themeSpace.xl }}>
            <div style={{ backgroundColor: themeColors.white, borderRadius: themeRadius.card, padding: 0, width: '90%', maxWidth: '800px', maxHeight: '90vh', overflow: 'hidden', boxShadow: themeShadow.lg }}>
              {/* Modal Header */}
              <div style={{ padding: themeSpace.lg, borderBottom: `1px solid ${themeColors.gray200}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: `linear-gradient(135deg, ${themeColors.primary50} 0%, ${themeColors.purple50} 100%)` }}>
                <div>
                  <h2 style={{ fontSize: '20px', fontWeight: '700', color: themeColors.text, margin: 0 }}>Create AI Campaign</h2>
                  <p style={{ fontSize: '13px', color: themeColors.gray600, margin: 0, marginTop: themeSpace.xs }}>Configure automated behavioral targeting</p>
                </div>
                <button onClick={() => setShowCreateForm(false)} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: themeSpace.sm }}>
              ...
              <div style={{ padding: themeSpace.lg, overflowY: 'auto', maxHeight: 'calc(90vh - 160px)' }}>
                ...
                <div style={{ marginBottom: themeSpace.lg }}>
                  <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', color: themeColors.gray700, marginBottom: themeSpace.sm }}>Campaign Name *</label>
                  <input
                    type="text"
                    value={newCampaign.name}
                    onChange={(e) => setNewCampaign(prev => ({ ...prev, name: e.target.value }))}
                    placeholder="e.g., Weekend Flash Sale"
                    style={{ width: '100%', padding: themeSpace.md, border: `1px solid ${themeColors.gray200}`, borderRadius: themeRadius.sm, fontSize: '14px', boxSizing: 'border-box' }}
                  />
                </div>

                {/* Campaign Type */}
                <div style={{ marginBottom: themeSpace.lg }}>
                  <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', color: themeColors.gray700, marginBottom: themeSpace.sm }}>Campaign Type *</label>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: themeSpace.sm }}>
                    {CAMPAIGN_TYPES.map(type => (
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'center', gap: themeSpace.sm, marginBottom: themeSpace.xs }}>
                ...
                {/* Target Segments */}
                <div style={{ marginBottom: themeSpace.lg }}>
                  <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', color: themeColors.gray700, marginBottom: themeSpace.sm }}>Target Segments *</label>
                    ...
                    {BEHAVIORAL_PATTERNS.map(segment => (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '11px', color: themeColors.gray500 }}>{segment.count.toLocaleString()} users</div>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                {/* Notification Channels */}
                <div style={{ marginBottom: themeSpace.lg }}>
                  <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', color: themeColors.gray700, marginBottom: themeSpace.sm }}>Notification Channels *</label>
                ...
                {/* Schedule */}
                <div style={{ marginBottom: themeSpace.lg }}>
                  <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', color: themeColors.gray700, marginBottom: themeSpace.sm }}>Schedule (Optional)</label>
                  <input
                    type="datetime-local"
                    value={newCampaign.scheduleDate}
                    onChange={(e) => setNewCampaign(prev => ({ ...prev, scheduleDate: e.target.value }))}
                    style={{ padding: themeSpace.md, border: `1px solid ${themeColors.gray200}`, borderRadius: themeRadius.sm, fontSize: '14px' }}
                  />
                ...
                <div style={{ padding: themeSpace.lg, backgroundColor: themeColors.gray50, borderRadius: themeRadius.md }}>
                  <h4 style={{ fontSize: '14px', fontWeight: '600', color: themeColors.gray700, margin: 0, marginBottom: themeSpace.md }}>Advanced Options</h4>
                    ...
                    {[
                      ...
                      >
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <p style={{ fontSize: '12px', color: themeColors.gray500, margin: 0, marginTop: themeSpace.xs }}>{option.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              {/* Modal Footer */}
              <div style={{ padding: themeSpace.lg, borderTop: `1px solid ${themeColors.gray200}`, display: 'flex', justifyContent: 'flex-end', gap: themeSpace.md }}>
                <button
