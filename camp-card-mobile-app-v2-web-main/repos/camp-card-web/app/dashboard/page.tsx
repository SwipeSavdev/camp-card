...
export default function Dashboard() {
 ...
 {/* Content */}
 <div style={{ flex: 1, padding: themeSpace.xl, overflowY: 'auto', backgroundColor: themeColors.gray50 }}>
 {/* Welcome */}
 <div style={{ marginBottom: themeSpace['3xl'] }}>
 <h1 style={{ fontSize: '28px', fontWeight: '700', color: themeColors.text, margin: 0, marginBottom: themeSpace.sm }}>Welcome back, {session?.user?.name || 'Admin'}</h1>
 ...
 <p style={{ margin: 0, fontSize: '13px', color: themeColors.gray600, fontWeight: '500' }}>{stat.label}</p>
 <div style={{ color: themeColors.primary600 }}>
 <Icon name={stat.icon} size={20} color={themeColors.primary600} />
 </div>
 </div>
 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: themeSpace.md }}>
 <h3 style={{ margin: 0, fontSize: '32px', fontWeight: '700', color: themeColors.text }}>{stat.value}</h3>
 <span style={{ padding: `${themeSpace.xs} ${themeSpace.sm}`, backgroundColor: themeColors.success50, color: themeColors.success600, borderRadius: themeRadius.sm, fontSize: '12px', fontWeight: '600' }}>{stat.trend}</span>
 </div>
 </div>
 </div>
 ))}
 ...
 <div>
 <p style={{ margin: 0, fontSize: '15px', fontWeight: '600', color: themeColors.text }}>All systems operational</p>
 <p style={{ margin: 0, fontSize: '13px', color: themeColors.gray600, marginTop: themeSpace.xs }}>Your Camp Card ecosystem is running smoothly.</p>
 </div>
 </div>
 <button
 ...
 >
 <h3 style={{ margin: 0, fontSize: '16px', fontWeight: '600', color: themeColors.text, marginBottom: themeSpace.lg }}>Recent Activity</h3>
 ...
 <div key={idx} style={{ display: 'flex', gap: themeSpace.md, paddingBottom: idx < 3 ? themeSpace.md : 0, borderBottom: idx < 3 ? `1px solid ${themeColors.gray100}` : 'none' }}>
 ...
 <div style={{ flex: 1 }}>
 <p style={{ margin: 0, fontSize: '14px', fontWeight: '500', color: themeColors.text }}>{item.title}</p>
 <p style={{ margin: 0, fontSize: '12px', color: themeColors.gray500, marginTop: themeSpace.xs }}>{item.time}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 >
 <h3 style={{ margin: 0, fontSize: '16px', fontWeight: '600', color: themeColors.text, marginBottom: themeSpace.lg }}>Quick Actions</h3>
 <div style={{ display: 'flex', flexDirection: 'column', gap: themeSpace.md }}>
 {[
