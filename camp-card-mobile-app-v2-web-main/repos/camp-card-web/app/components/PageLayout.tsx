  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: themeColors.gray50 }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        {/* Header */}
        <div style={{ padding: `${themeSpace.md} ${themeSpace.xl}`, backgroundColor: themeColors.white, borderBottom: `1px solid ${themeColors.gray200}`, boxShadow: themeShadow.xs, display: 'flex', alignItems: 'center', gap: themeSpace.md }}>
          <button
          ...
          <h1 style={{ margin: 0, fontSize: '20px', fontWeight: '600', color: themeColors.text }}>{title}</h1>
        </div>
