...
export default function FeatureFlagsPage() {
 ...
 {/* Modal Header */}
 <div className="sticky top-0 bg-gray-50 border-b border-gray-200 px-6 py-4 flex justify-between items-center">
 <h2 className="text-xl font-bold">Audit Log: {selectedFlag.name}</h2>
 <button
 ...
 <p><strong>Changed by:</strong> {log.changed_by.name} ({log.changed_by.email})</p>
 ...
 <strong>{key}:</strong> {String(log.old_value?.[key])}  {String(log.new_value?.[key])}
 </p>
 )
 ))}
 </div>
