...
function Icon({ name, size = 18, color = 'currentColor' }: { name: string; size?: number; color?: string }) {
  const icons: { [key: string]: any } = {
    ...
    calendar: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    ...
    mapPin: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
      <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
      <circle cx="12" cy="10" r="3" />
            </svg>,
    user: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: themeColors.gray50 }}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, padding: themeSpace.xl, overflowY: 'auto' }}>
          ...
          {/* Profile Card */}
          <div style={{
            backgroundColor: themeColors.white, borderRadius: themeRadius.card, border: `1px solid ${themeColors.gray200}`, overflow: 'hidden', boxShadow: themeShadow.sm, maxWidth: '800px',
          }}
          >
            {/* Profile Header */}
            <div style={{
              padding: themeSpace.xl, background: `linear-gradient(135deg, ${themeColors.primary600} 0%, ${themeColors.info600} 100%)`, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start',
            }}
            >
              <div style={{ display: 'flex', gap: themeSpace.lg, alignItems: 'flex-start' }}>
                ...
                <div style={{ color: themeColors.white }}>
                  {isEditing ? (
                   ...
                   <h2 style={{
                   margin: 0, fontSize: '24px', fontWeight: '700', marginBottom: themeSpace.sm,
                 }}
                 >
                   {profile.name}
                 </h2>
            ...
            <div style={{ padding: themeSpace.xl }}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: themeSpace.xl }}>
                ...
                <div style={{ gridColumn: 'span 2' }}>
                  <h3 style={{
                    fontSize: '14px', fontWeight: '600', color: themeColors.gray600, margin: '0 0 16px 0', textTransform: 'uppercase',
                  }}
                  >Contact Information
                  </h3>
                  ...
                  <div style={{
                    display: 'grid', gridTemplateColumns: '1fr 1fr', gap: themeSpace.lg, marginBottom: themeSpace.lg,
                  }}
                  >
                    {/* Email */}
                    <div>
                   ...
                   <p style={{
                   margin: 0, fontSize: '14px', color: themeColors.text, display: 'flex', gap: themeSpace.sm, alignItems: 'center',
                 }}
                 >
                   ...
                   <p style={{
                   margin: 0, fontSize: '14px', color: profile.phone ? themeColors.text : themeColors.gray500, display: 'flex', gap: themeSpace.sm, alignItems: 'center',
                 }}
                 >
                   ...
                   <p style={{
                   margin: 0, fontSize: '14px', color: profile.address ? themeColors.text : themeColors.gray500, display: 'flex', gap: themeSpace.sm, alignItems: 'center',
                 }}
                 >
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: themeSpace.lg }}>
                   ...
                   >Role
                     ...
                     <span style={{
                     padding: `${themeSpace.xs} ${themeSpace.sm}`, backgroundColor: themeColors.primary50, color: themeColors.primary600, borderRadius: themeRadius.sm, fontSize: '12px', fontWeight: '500', display: 'inline-block',
                   }}
                   >
                     {profile.role}
                   </span>
              ...
              {/* Action Buttons */}
              <div style={{
                marginTop: themeSpace.xl, paddingTop: themeSpace.xl, borderTop: `1px solid ${themeColors.gray200}`, display: 'flex', gap: themeSpace.md,
              }}
              >
                {isEditing && (
                <button
