...
export default function SubscriptionsPage() {
 ...
 {/* Summary Stats */}
 <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: themeSpace.lg, marginBottom: themeSpace.xl }}>
 ...
 <div style={{ fontSize: '32px', fontWeight: '700', color: themeColors.text, marginBottom: themeSpace.xs }}>
 {stat.value}
 </div>
 ...
 {/* Plan Breakdown */}
 <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: themeSpace.lg, marginBottom: themeSpace.xl }}>
 {/* Subscription Plans */}
 <div
 style={{
 backgroundColor: themeColors.white,
 ...
 >
 <h2 style={{ fontSize: '16px', fontWeight: '700', color: themeColors.text, margin: 0, marginBottom: themeSpace.lg }}>
 ...
 <span style={{ fontSize: '13px', color: themeColors.gray600 }}>{plan.count.toLocaleString()} subscribers</span>
 </div>
 <div style={{ height: '8px', backgroundColor: themeColors.gray200, borderRadius: themeRadius.sm, overflow: 'hidden' }}>
 <div
 style={{
 height: '100%',
 ...
 <span style={{ fontSize: '11px', color: themeColors.gray500 }}>{plan.percentage}%</span>
 </div>
 </div>
 ))}
 </div>
 ...
 <span style={{ fontSize: '11px', color: themeColors.gray500, marginTop: themeSpace.xs, display: 'block' }}>
 ...
 <div style={{ fontSize: '28px', fontWeight: '700', color: themeColors.text, marginBottom: themeSpace.xs }}>
 {metric.value}
 </div>
 <div
 style={{
 ...
 >
 {metric.change} {metric.type === 'positive' ? '' : metric.type === 'negative' ? '' : ''}
 </div>
 </div>
 ))}
 </div>
