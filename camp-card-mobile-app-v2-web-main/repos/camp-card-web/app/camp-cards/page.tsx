...
export default function CampCardsPage() {
 ...
 <div style={{ display: 'grid', gridTemplateColumns: '1fr auto auto', gap: themeSpace.md, alignItems: 'center', marginBottom: themeSpace.lg }}>
 <div style={{ position: 'relative' }}>
 <Icon name="search" size={18} color={themeColors.gray500} style={{ position: 'absolute', left: themeSpace.md, top: '12px', pointerEvents: 'none' }} />
 <input
 type="text"
 ...
 <p style={{ fontSize: '16px', fontWeight: '500', margin: 0, marginBottom: themeSpace.md }}>No cards found</p>
 ...
 <th style={{ textAlign: 'left', padding: themeSpace.lg, fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Cardholder</th>
 <th style={{ textAlign: 'left', padding: themeSpace.lg, fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Card Number</th>
 <th style={{ textAlign: 'left', padding: themeSpace.lg, fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Status</th>
 <th style={{ textAlign: 'left', padding: themeSpace.lg, fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Method</th>
 <th style={{ textAlign: 'left', padding: themeSpace.lg, fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Issued</th>
 <th style={{ textAlign: 'left', padding: themeSpace.lg, fontSize: '13px', fontWeight: '600', color: themeColors.gray600 }}>Expires</th>
 ...
 <td style={{ padding: themeSpace.lg, fontSize: '14px', color: themeColors.text, fontWeight: '500' }}>
 <div>{item.name || item.cardholderName || 'Unknown'}</div>
 {claimToken && item.status?.toUpperCase() === 'PENDING_CLAIM' && (
 <div style={{ fontSize: '12px', color: themeColors.warning600, marginTop: themeSpace.xs, fontFamily: 'monospace' }}>
 {claimToken}
 </div>
 )}
 </td>
 <td style={{ padding: themeSpace.lg, fontSize: '14px', color: themeColors.text, fontFamily: 'monospace' }}>
 {item.cardNumber ? ` ${item.cardNumber.slice(-4)}` : 'N/A'}
 </td>
 <td style={{ padding: themeSpace.lg }}>
 <span style={{ padding: `${themeSpace.xs} ${themeSpace.sm}`, backgroundColor: statusColor.bg, color: statusColor.text, borderRadius: themeRadius.sm, fontSize: '12px', fontWeight: '500', display: 'inline-block' }}>
