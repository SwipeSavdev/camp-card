...
function SetPasswordForm() {
  ...
  useEffect(() => {
    if (!token) {
      setError('Invalid setup token. Please contact your administrator for a new invitation.');
    }
  }, [token]);
        ...
        >
          ...
          >
            ...
            <ul style={{ margin: 0, paddingLeft: '20px', fontSize: '12px', color: colors.green600 }}>
              ...
              <li style={{ marginBottom: '4px' }}>Explore the BSA Camp Card platform</li>
              <li>Start making the most of your account</li>
            </ul>
          </div>
    ...
    >
      ...
      >
        <div style={{ marginBottom: space.xl }}>
          ...
          >
            Your account has been created. Please create a secure password to complete your account setup.
          </p>
        </div>
