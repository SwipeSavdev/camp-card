...
export default function ScoutsPage() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: themeColors.gray50 }}>
      <div style={{
        flex: 1, display: 'flex', flexDirection: 'column', padding: `${themeSpace.xl} ${themeSpace.lg}`,
      }}
      >
        <div style={{ marginBottom: themeSpace.xl }}>
          ...
          <p style={{ fontSize: '14px', color: themeColors.gray600, margin: 0 }}>
            Manage scout organizations and events
          </p>
        </div>
        <div style={{
          backgroundColor: themeColors.white, borderRadius: themeRadius.card, padding: themeSpace.xl, flex: 1,
        }}
        >
          <p style={{ color: themeColors.gray600 }}>Scout data will appear here</p>
        </div>
      </div>
    </div>
  );
