...
export default function HealthPage() {
  ...
  const [health, _setHealth] = useState(healthStatus);
    ...
    <PageLayout title="System Health" currentPath="/health">
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
        ...
        >
          ...
          >
            <div style={{
              display: 'flex', alignItems: 'center', gap: themeSpace.md, marginBottom: themeSpace.md,
            }}
            >
              <Icon name="checkCircle" size={24} color={themeColors.success600} />
              <div>
                <p style={{
                  margin: 0, fontSize: '12px', color: themeColors.gray600, fontWeight: '500',
                }}
                >
Healthy Services
</p>
                <p style={{
                  margin: 0, fontSize: '24px', fontWeight: '700', color: themeColors.success600,
                }}
                >
{healthyCount}
                </p>
...
Warnings
                ...
                <p style={{
                  margin: 0, fontSize: '24px', fontWeight: '700', color: themeColors.warning600,
                }}
                >
{warningCount}
                </p>
...
Errors
                ...
                <p style={{
                  margin: 0, fontSize: '24px', fontWeight: '700', color: themeColors.error600,
                }}
                >
{errorCount}
                </p>
        ...
        >
          <h2 style={{
            margin: `0 0 ${themeSpace.lg} 0`, fontSize: '18px', fontWeight: '700', color: themeColors.text,
          }}
          >
            Performance Metrics
          </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: themeSpace.lg }}>
            <div>
              <p style={{
                margin: `0 0 ${themeSpace.sm} 0`, fontSize: '12px', fontWeight: '600', color: themeColors.gray600, textTransform: 'uppercase',
              }}
              >
                API Response Time
</p>
              <p style={{
                margin: 0, fontSize: '24px', fontWeight: '700', color: themeColors.text,
              }}
              >
                45ms
</p>
