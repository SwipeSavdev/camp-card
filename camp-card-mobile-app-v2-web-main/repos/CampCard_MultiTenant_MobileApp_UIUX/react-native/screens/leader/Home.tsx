...
export default function LeaderHome() {
 ...
 <Text style={{ color: "white", fontSize: 18, fontWeight: "800" }}>Dashboard</Text>
 ...
 <Text style={{ color: "white", fontWeight: "800" }}>Share troop link</Text>
 </Pressable>
 ...
 <Text style={{ color: colors.text, fontWeight: "800" }}>Manage scouts</Text>
 </Pressable>
 </View>
 </View>
 );
