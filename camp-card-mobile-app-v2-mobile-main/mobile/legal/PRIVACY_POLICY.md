...
Swipe Savvy, LLC ("Swipe Savvy," "Company," "we," "us," or "our") operates the Camp Card mobile application ("App," "Service") and related services. This Privacy Policy explains how we collect, use, process, disclose, and safeguard your information when you access or use our Service.

**BY DOWNLOADING, INSTALLING, ACCESSING, OR USING THE APP, YOU EXPRESSLY ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE TO BE BOUND BY THIS PRIVACY POLICY. IF YOU DO NOT AGREE TO THIS PRIVACY POLICY, YOU MUST NOT USE THE APP AND SHOULD IMMEDIATELY DELETE IT FROM YOUR DEVICE.**

This Policy applies to all users of the Camp Card mobile application, including Scouts, parents, troop leaders, merchants, and administrators. Your continued use of the Service following any updates to this Policy constitutes your acceptance of such changes.
...
7. [Children's Privacy (COPPA Compliance)](#7-childrens-privacy-coppa-compliance)
8. [California Privacy Rights (CCPA)](#8-california-privacy-rights-ccpa)
...
**Payment Information:**
- Credit/debit card details (processed securely by Authorize.net; we do not store full card numbers)
- Billing address
- Transaction history
...
When you use the App, we automatically collect certain information through cookies, log files, and similar technologies:

**Device Information:**
- Device type, model, and manufacturer
- Operating system and version
- Unique device identifiers (including but not limited to IDFA, GAID, device serial numbers)
...
- GPS coordinates (with your explicit permission)
- IP address-based approximate location
- Nearby merchant searches
- Geofencing data

**Log Data:**
- Access times and dates
- App crashes, errors, and diagnostics
...
**You authorize us to collect, process, and use information from these third-party sources in accordance with this Policy.**
...
- Provide access to merchant offers and discounts
- Enable QR code redemption functionality
- Display nearby merchants and offers
- Track savings, redemptions, and activity
- Fulfill your requests and transactions

### 2.2 Communication
- Send account-related notifications and alerts
- Provide customer support and respond to inquiries
- Send promotional offers, marketing communications, and newsletters (with consent where required)
- Alert you to new merchants, offers, or features
- Notify you of policy changes and updates
...
- Create aggregated, anonymized, or de-identified data sets

### 2.4 Security, Compliance, and Legal Purposes
...
- Protect the rights, property, and safety of Swipe Savvy, our users, and the public
...
**You acknowledge and agree that we may use your information for any purpose described in this Policy without further notice or compensation to you.**
...
- Authorize.net (payment processing and fraud prevention)
...
- Offer availability confirmation
- Limited information necessary for service fulfillment

**Legal and Regulatory:**
- Law enforcement agencies upon valid legal request
- Courts pursuant to court orders or subpoenas
...
### 3.2 Additional Disclosure Circumstances

We may also disclose your information:

- **Business Transfers:** In connection with any merger, acquisition, financing, sale of company assets, or transition of service to another provider, your information may be transferred as part of such transaction. You acknowledge that such transfers may occur and that any acquirer may continue to use your information as set forth in this Policy.

- **Consent:** When you have provided consent for a specific disclosure.

- **Aggregated/De-identified Data:** We may share aggregated, anonymized, or de-identified information that cannot reasonably be used to identify you without restriction.

- **Protection of Rights:** When we believe disclosure is necessary to protect our rights, your safety, or the safety of others; investigate fraud; or respond to government requests.

### 3.3 Data Processing by Third Parties

Our service providers and partners may process your information on our behalf. We require these parties to maintain appropriate security measures and use your information only for the purposes for which it was disclosed.

### 3.4 We Do NOT:
- Sell your personal information for monetary consideration
- Share data with third-party advertisers for behavioral advertising targeting
- Provide personal data to unaffiliated third parties for their direct marketing purposes
- Share children's data without appropriate parental consent
...
- **Password Security:** Passwords hashed using BCrypt with appropriate work factor
- **Payment Security:** PCI-DSS compliant payment processing via Authorize.net
- **Access Controls:** Role-based access controls and authentication for internal systems
- **Credential Encryption:** Sensitive API credentials encrypted using AES-256-GCM
...
- Reporting unauthorized access or security concerns immediately
- Keeping your device and software secure and up to date
- Using strong, unique passwords

### 4.3 No Guarantee of Security

**WHILE WE IMPLEMENT REASONABLE SECURITY MEASURES, NO METHOD OF TRANSMISSION OVER THE INTERNET OR ELECTRONIC STORAGE IS 100% SECURE. WE CANNOT AND DO NOT GUARANTEE ABSOLUTE SECURITY OF YOUR INFORMATION. ANY TRANSMISSION OF INFORMATION IS AT YOUR OWN RISK.**
...
| Usage Analytics | 3 years (anonymized thereafter) |
...
- Personal information will be deleted or anonymized within 30 days
...
- Transaction records retained as required for legal and tax purposes

### 5.3 Survival

Certain provisions of this Policy, including but not limited to limitation of liability, indemnification, and dispute resolution, shall survive termination of your account.
...
- Certain requests may be denied where permitted by law
...
- Verifiable parental consent is obtained during registration

### 7.3 Information Collected from Minors

We collect only information necessary for service provision:
- Name (first name only for children under 13)
- Email (parent's email for children under 13)
...
- Access their child's account information
- Control notification and privacy settings
- Delete their child's account
- Opt-out of data collection

### 7.5 Contact for Parents

Parents with questions about children's privacy:
...
**Right to Opt-Out of Sale/Sharing:** Opt-out of sale or sharing of personal information
...
### 8.2 Notice Regarding Sale/Sharing

**We do NOT sell your personal information for monetary consideration. We do NOT share your personal information for cross-context behavioral advertising purposes.**

### 8.3 Categories of Information

| Category | Examples | Collected | Disclosed |
|----------|----------|-----------|-----------|
| Identifiers | Name, email, phone, IP address | Yes | Yes |
| Commercial Information | Purchase history, subscriptions | Yes | Yes |
| Internet Activity | App usage, browsing | Yes | Yes |
| Geolocation | GPS coordinates | Yes | Yes |
| Inferences | Preferences, characteristics | Yes | No |

### 8.4 Exercising CCPA Rights

California residents may submit requests:
- Email: support@swipesavvy.com
- Online: https://www.campcardapp.org/privacy/california

### 8.5 Authorized Agents

You may designate an authorized agent with written permission and proper verification.

---

## 9. International Users

### 9.1 United States Service

Camp Card is designed for use in the United States. By accessing the App from outside the US:
- Your data will be transferred to and processed in the United States
- US privacy laws apply and may differ from your jurisdiction
- You expressly consent to such transfer and processing

### 9.2 GDPR Notice (European Users)
...
- Contact: support@swipesavvy.com
...
|---------|---------|----------------|
| Authorize.net | Payment processing | https://www.authorize.net/about-us/privacy/ |
| Firebase | Analytics, push notifications | https://firebase.google.com/support/privacy |
| AWS | Cloud infrastructure | https://aws.amazon.com/privacy/ |
| Google Maps | Location services | https://policies.google.com/privacy |

### 10.2 Third-Party Responsibility

**WE ARE NOT RESPONSIBLE FOR THE PRIVACY PRACTICES OF THIRD-PARTY SERVICES. YOUR USE OF SUCH SERVICES IS AT YOUR OWN RISK.**

### 10.3 Third-Party Links

The App may contain links to third-party websites. We are not responsible for their content or privacy practices.
...
- New offers and merchants near you
- Subscription and account reminders
- Security alerts and account notifications
- Troop activity updates
- Service announcements

### 11.2 Managing Notifications

Control notifications via:
- **In-App:** Profile > Settings > Notifications
- **Device Settings:** iOS Settings or Android Settings

### 11.3 Essential Notifications

Certain notifications are necessary for service operation and cannot be disabled while using the App:
- Security alerts and authentication
...
### 12.1 Use of Location

With your permission, we use location to:
- Display nearby merchants and offers
- Sort results by distance
- Provide navigation assistance
- Improve service relevance

### 12.2 Location Permissions

- Location access is optional but may limit functionality
- You control location access through device settings
- We do NOT collect background location data

### 12.3 Managing Location

Control location access:
- **iOS:** Settings > Privacy & Security > Location Services > Camp Card
- **Android:** Settings > Apps > Camp Card > Permissions > Location
...
| Your Rights | Access, correct, delete, port, and opt-out (where applicable) |
| Disputes | Binding arbitration with class action waiver |
| Liability | Limited to amounts paid or $100, whichever is greater |
| Contact | support@swipesavvy.com |
...
**BY USING CAMP CARD, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE TO BE BOUND BY THIS PRIVACY POLICY.**

---

*This Privacy Policy was drafted to comply with applicable US federal and state privacy laws, including COPPA and CCPA/CPRA, as well as Apple App Store and Google Play Store requirements.*
